   ...
   class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region extensions
            var bank = new Bank { Name = "Test bank", RoutingNumber = 12345 };
            var res = bank.GetBankNameAndRouting();

            var account = new Account { Number = "3", Balance = 500 };
            var result = account.GetAccountNumerAndBalance();
            #endregion
        }
